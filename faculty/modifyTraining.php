                ...
                <thead class = "thead-dark" id="myTable">
                  ...
                  <?php foreach($result as $row){?>
                       ...
                       <tr>
                              ...
                              <td class="text-white bg-dark"><form class="" action="changeTraining.php" method="post">
                              <button type="submit" class="btn btn-info" name="changeTraining" value="<?php echo $row['training_id']?>">Change</button>
