                ...
                <thead class = "thead-dark" id="myTable">
                  ...
                  <?php foreach($result as $row){?>
                       ...
                       <tr>
                              ...
                              <td class="text-white bg-dark"><form class="" action="changePatent.php" method="post">
                              <button type="submit" class="btn btn-info" name="changePatent" value="<?php echo $row['patent_id']?>">Change</button>
